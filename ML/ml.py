...
def run(argv):
    ...
    clss = ["Isolation Forest", "One-Class SVM",  "Robust covariance","SGD One-Class SVM", "Local Outlier Factor"]
    res = []
    for feature in features:
        ...
        for clsname in clss:
            if ("sequence" in feature and clsname == "Robust covariance"):
                print("Skipping "+ clsname + " for " + feature)
                continue
